...
exporter, registry, and sink contracts.

| Area | Supported integrations |
| --- | --- |
| Data | Verified Parquet, CSV, Iceberg, Lance, PostgreSQL, and Ray HiveServer2 paths; gated external ClickHouse/Doris adapters |
