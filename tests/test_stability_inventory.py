...
STABILITY_MAP: dict[str, str] = {
    ...
    "tributo.algorithms.builtin.x_learner": "alpha",
    ...
    "tributo.integrations.exporters.x_learner": "alpha",
    ...
    "tributo.integrations.flavors.x_learner": "alpha",
    ...
    "tributo.integrations.model_runtimes.bundle": "alpha",
    "tributo.integrations.model_runtimes.explainability": "alpha",
    "tributo.integrations.model_runtimes.resolver": "alpha",
    "tributo.integrations.validators": "beta",
    "tributo.integrations.validators.xgboost_native": "beta",
    "tributo.integrations.sources": "beta",
    "tributo.integrations.sources.ray_torch_recipe": "alpha",
    "tributo.integrations.sources.ray_x_learner": "alpha",
    ...
    "tributo.integrations.sinks.explainability": "alpha",
