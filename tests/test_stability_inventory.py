...
STABILITY_MAP: dict[str, str] = {
    ...
    "tributo.algorithms.conformance": "alpha",
    ...
    "tributo.algorithms.spi.contracts": "alpha",
    ...
    "tributo.training.portable_tune": "alpha",
    ...
    "tributo.integrations.sources.ray_torch": "alpha",
